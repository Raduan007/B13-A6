    ...
    return (
        <div className='mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center mt-10 max-w-7xl px-2 text-center lg:text-left'>
            <div className="space-y-4"> 
                ...
                <p className='opacity-70 pb-4'>Access premium AI tools, design assets, templates, and productivity software—all in one place. Start creating faster today.Explore Products</p> 
                <div className='flex flex-col sm:flex-row gap-5 items-center justify-center lg:justify-start'>
                    ...
                    <div className="p-[2px] bg-gradient-to-r from-[#4F39F6] to-[#9514FA] rounded-[50px] ">
                        <button className='bg-white w-40 h-12 flex items-center justify-center rounded-[50px] gap-2'>
